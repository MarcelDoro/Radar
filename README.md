...
$$343\frac{m}{s}=343*\frac{100\text{ cm}}{1 000 000\text{ $\mu s$}}=0,0343\frac{cm}{\mu s}$$

The value of $t$ is known, because it's calcuclated by ultrasonic radar. For instance $t=~300\mu s$. Then

$$s=0,0343\frac{cm}{\mu s}*300\text{ $\mu s$} = 10,29\text{ cm}$$
...
$$\frac{s}{2}=\frac{v*t}{2}=\frac{10,29\text{ cm}}{2}=\underline{5,145\text{ cm}}$$